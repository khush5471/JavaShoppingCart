...
/*
* This class is used to add data to the Firebase,like adding the list of the brands and adding the brand products on firebase
* database.
*
...
public class AddDataToFireBase {
    ...
    public static AddDataToFireBase objAddDataToFireBase=new AddDataToFireBase();

    private AddDataToFireBase(){

    }

    public static AddDataToFireBase getInstance(){return objAddDataToFireBase; }

    public void setDataListToFirebase() {
        DatabaseReference myUserReferences=FireBaseHandler.getInstance().getFirebaseDatabaseReference("USERS");
